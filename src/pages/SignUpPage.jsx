        ...
        <>
            ...
            <section className={"signUpPageContainer"}>
                <form >
                    ...
                    <input name='organisationUsername' value={signUpFormData.organisationUsername} onChange={handleInputValueChange} type="text" placeholder="Organisation Username" />
                    <br />
                    <label>Email:</label>
                    <input name='email' value={signUpFormData.email} onChange={handleInputValueChange} type="email" placeholder="Email" />
                    <br />
                    ...
                    <br />
                    <p>Already have an account?   <RouteLink to="/logInPage" className="loginLink">Login</RouteLink></p>
                </form>
            </section>
